...
Diese win32-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre win32-Anwendung besteht.
...
win32.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "win32.rc" 
    enthalten.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "win32.pch und eine 
