========================================================================
    STATISCHE BIBLIOTHEK: libproject-Projektübersicht
========================================================================

Dieses libproject-Bibliotheksprojekt wurde vom 
Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre libproject-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "libproject.pch und eine 
